        ...
        self.theme_cls.font_styles.update(
            {
                ...
                "Subtitle1": [FONT_PATH + "LibreFranklin-Medium", 16, False, 0.15],
                "Subtitle2": [FONT_PATH + "Merriweather-Regular", 14, False, 0.1],
                ...
                "Caption": [FONT_PATH + "Merriweather-BlackItalic", 12, False, 0.4],
                "Overline": [FONT_PATH + "LibreFranklin-Bold", 10, True, 1.5],
            }
        )
